local Module = BlokyUI:NewModule("Chat.Core");
...
function Module:OnEnable()
	...
	-- move the edit mode selection box in the right frame
	ChatFrame1.Selection:ClearAllPoints();
	ChatFrame1.Selection:SetPoint("TOPLEFT", QuickJoinToastButton, "TOPLEFT", 0, 0);
	ChatFrame1.Selection:SetPoint("BOTTOMRIGHT", ChatFrame1, "BOTTOMRIGHT", 25, -35);

	QuickJoinToastButton:ClearAllPoints();
	QuickJoinToastButton:SetPoint("TOPLEFT", ChatFrame1, "TOPLEFT", 0, 60);
	QuickJoinToastButton.Toast:ClearAllPoints();
	QuickJoinToastButton.Toast:SetPoint("TOPLEFT", ChatFrame1, "TOPLEFT", 0, 100);
	QuickJoinToastButton.Toast2:ClearAllPoints();
	QuickJoinToastButton.Toast2:SetPoint("TOPLEFT", ChatFrame1, "TOPLEFT", 0, 120);
